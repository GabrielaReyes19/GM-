...
var url_path = '/pixel/';
var demo_themes = [
  { name: 'default', title: 'Default', img: url_path + 'demo/themes/default.png' },
  { name: 'asphalt', title: 'Asphalt', img: url_path + 'demo/themes/asphalt.png' },
  { name: 'purple-hills', title: 'Purple Hills', img: url_path + 'demo/themes/purple-hills.png' },
  { name: 'adminflare',  title: 'Adminflare', img: url_path + 'demo/themes/adminflare.png' },
  { name: 'dust',  title: 'Dust', img: url_path + 'demo/themes/dust.png' },
  { name: 'frost',  title: 'Frost', img: url_path + 'demo/themes/frost.png' },
  { name: 'fresh',  title: 'Fresh', img: url_path + 'demo/themes/fresh.png' },
  { name: 'silver',  title: 'Silver', img: url_path + 'demo/themes/silver.png' },
  { name: 'clean',  title: 'Clean', img: url_path + 'demo/themes/clean.png' },
  { name: 'white',  title: 'White', img: url_path + 'demo/themes/white.png' }
];
...
window.addEventListener("load", function () {
  ...
  $('head').append($('<style>\n' + demo_styles.join('\n') + '\n</style>'));
  //$('body').append($(demo_template.join('\n'))); /* HABILITAR ESTA LINEA PARA CONFIGURAR THEMES */
