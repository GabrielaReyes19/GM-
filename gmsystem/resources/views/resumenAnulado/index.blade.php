...
<div class="page-header padding-xs-vr" style="margin: -18px -18px 5px -18px;">      
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-8 text-center text-left-sm">
            ...
            <span class="text-light-gray">ANULACIONES  / </span>Anulación de Boletas y Notas / Administrador
        </h1>
    ...
    init.push(function () {        
        ...
        $("#find-{{ $nameModule }}-form").validate({
            ...
            submitHandler: function(form) {
                ...
                var ajax_source = "{{ url('api.resumenAnuladoRc') }}?" + query_string;
