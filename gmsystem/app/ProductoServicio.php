...
class ProductoServicio extends Model
{
	...
	public function scopeBusqueda($query, $pro="")
    {
        $query = ProductoServicio::NombreProducto($pro)
    ...
    public function scopeNombreProducto($query,$pro="")
    {
        if(trim($pro) != ""){

            $query->where('mae_producto.c_nom','like','%'.$pro.'%');
